...
export default {
  ...
  async mounted() {
    this.geoButton = document.getElementById("geoButton")
    this.searchButton = document.getElementById("searchButton")
    this.log = document.getElementById("log")
    this.checkButton1 = document.getElementById("checkBox1")
    this.checkButton2 = document.getElementById("checkBox2")
    this.checkButton3 = document.getElementById("checkBox3")
    this.checkButton4 = document.getElementById("checkBox4")
    this.checkButton5 = document.getElementById("checkBox5")
    this.checkButton6 = document.getElementById("checkBox6")
  ...
  methods: {
    ...
    async search() {
      ...
      if(result.length === 0)
      {
        ...
        // ここで要素を二番目に追加
        this.log.add(option, 1)
      }
      // プルダウンの項目数
      this.optionCount = this.log.length
      ...
      // 空白分があるため+1をする
      this.log.options[selectOption+1].selected = true
    },
    async geocode() {
    ...
    async randomGenre() {
      ...
      switch(randNum) {
        ...
        case 1:
          ...
          break
        case 2:
          this.checkButton3.checked = true
          this.genres.push("中華")
          break
        case 3:
          this.checkButton4.checked = true
          this.genres.push("居酒屋")
          break
        case 4:
          this.checkButton5.checked = true
          this.genres.push("ラーメン")
          break
        case 5:
          this.checkButton6.checked = true
          this.genres.push("弁当")
          break
      }
    },
    ...
    async resetGenre() {
      ...
      this.checkButton5.checked = false
      this.checkButton6.checked = false
    }
  },
  computed: {
    own() {
  ...
  watch: {
    ...
    genres: async function(){
      if(this.genres.length > 0) {
        this.log.options[0].selected = true;
        this.genreTextHoge = ''
      }
