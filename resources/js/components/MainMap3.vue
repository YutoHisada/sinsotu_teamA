<template>
  <div class="container">
    ...
    mainmap333
    <div class="row">
      <div class="map col-md-4" ref="googleMap" style="float: left" />
      <div class="col-md-2">
...
export default {
  ...
  methods: {
    ...
    async getLatLng() {
      ...
      const TARGET_URL = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=${this.myAPI}&location=${this.lat},${this.lng}&radius=${this.radius}&type=${this.type}&keyword=${this.keyword}&language=ja`
